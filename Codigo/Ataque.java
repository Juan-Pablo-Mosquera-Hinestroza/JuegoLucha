public class Ataque {
    ...
    public Ataque(String nombre, String descripcion, int danoBase, double probCritico, double multiplicadorCritico) {
        this.nombre = nombre;
    ...
    public String toString() {
        return nombre + " (" + descripcion + ", Daño base: " + danoBase + ", Prob. crítico: " + (int)(probCritico*100) + "% x" + multiplicadorCritico + ")";
    }
}
